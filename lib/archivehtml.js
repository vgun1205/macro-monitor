...
capBtn.onclick=function(){
 ...
 var target=document.querySelector('.wrap')||document.body; // 전체 페이지 대신 내용 영역만 캡처
 html2canvas(target,{backgroundColor:'#eef1f5',scale:2,useCORS:true}).then(function(canvas){

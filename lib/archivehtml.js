 ...
 *{box-sizing:border-box}
 ...
 /* 기사 검색 섹션 — 브리핑과 동일한 카드 껍데기 */
 .sec{background:#fff;border:1px solid #e5e9f0;border-left:5px solid var(--acc);border-radius:16px;padding:20px 24px;margin:18px 0 6px;box-shadow:0 2px 12px rgba(11,22,34,.06)}
 ...
 .sec.collapsed{padding-bottom:18px}

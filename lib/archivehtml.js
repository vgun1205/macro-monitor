 ...
 *{box-sizing:border-box}
 ...
 .sub{color:#6b7280;font-size:12px;margin:0 0 8px}
 .kw{display:flex;flex-wrap:wrap;gap:5px;margin:0 0 12px;align-items:center}
 .kw .lb{font-size:12px;color:#6b7280;margin-right:2px}
 .chip{font-size:12px;padding:4px 9px;border:1px solid #cfe3e6;background:#eef7f8;color:#0e6070;border-radius:14px;cursor:pointer;user-select:none}
 .chip:hover{background:#dceef0}

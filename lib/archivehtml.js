 ...
 <div class="box" id="searchBox">
  ...
  <div class="filters">
   ...
   <div class="fg"><span class="fl">구분</span>
    <button class="fr on" data-rg="">전체</button>
    <button class="fr" data-rg="domestic">국내</button>
    <button class="fr" data-rg="global">글로벌</button>
   </div>
...
function daysAgo(a,d){var t=new Date(a+'T00:00:00');t.setDate(t.getDate()-d);return t.toISOString().slice(0,10);}
// 기간·구분 버튼
(function(){
 ...
 for(var k=0;k<rbs.length;k++)rbs[k].onclick=function(){
  ...
  F.rg=this.getAttribute('data-rg'); reFilter();
 };
})();
...
document.getElementById('home').onclick=function(){F={q:'',from:'',to:'',rg:''};document.getElementById('q').value='';clearChips();resetFilterBtns();reFilter();window.scrollTo(0,0);};

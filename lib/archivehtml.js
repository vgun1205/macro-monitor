...
var KEYWORDS=['지급여력','K-ICS','경과조치','자본확충','신종자본증권','IFRS17','할인율','내부통제','금감원 검사','BCM::BCM|BCP|업무연속성','사업연속성','위험관리위원회','전산장애','제3자','위탁','클라우드','재보험','삼성화재','삼성생명','캐노피우스::Canopius|캐노피우스','Solvency','ICS'];

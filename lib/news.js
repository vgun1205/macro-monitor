...
const INS_KEYS = /보험|지급여력|K-?ICS|킥스|건전성|책임준비금|계리|손해보험|생명보험|할인율|자본확충|후순위|신종자본|내부통제|전산장애|업무연속성|사업연속성|위험관리위원회|위탁|소비자보호|분쟁조정|불완전판매|판매수수료|리베이트|모집질서|\bGA\b|약관|보험금|손해율|재보험|IFRS|경과조치|지배구조/i;
...
export async function fetchIssues(limit = 10, sinceTs = 0) {
  ...
  // 국내 순서: 1)금감원 보도 2)손보협회 보도 3)국내 뉴스 4)금감원 공지 5)손보협회 공지

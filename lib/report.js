...
export const SECTIONS = [
  ...
  { label: "주가", unit: "pt/원", rows: [
    ...
    ["skt", "SK텔레콤", "won"], ["skhynix", "SK하이닉스", "won"],
  ]},
...
export const DAILY_COLS = [
  ...
  { g: "환율", id: "usdkrw", label: "원/달러", fmt: "#,##0.0" }, { g: "환율", id: "eurkrw", label: "원/유로", fmt: "#,##0.0" },
  { g: "주가", id: "kospi", label: "코스피", fmt: "#,##0.0" }, { g: "주가", id: "samsung", label: "삼성전자", fmt: "#,##0" },
  { g: "주가", id: "samsungct", label: "삼성물산", fmt: "#,##0" }, { g: "주가", id: "skt", label: "SK텔레콤", fmt: "#,##0" }, { g: "주가", id: "skhynix", label: "SK하이닉스", fmt: "#,##0" },

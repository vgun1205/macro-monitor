...
// 파생: corp_aam_3y = 회사채AA-3년수익률 − 국고3Y
const DERIVED = { corp_aam_3y: ["corpAA3yYield", "ktb3y"] };
    ...
    rows: sec.rows.map(([id, label, kind]) => {
      ...
      return {
        ...
        levels: { y23: valAsOf(id, ref.y23), y24: valAsOf(id, ref.y24), y25: valAsOf(id, ref.y25),
          m3: valAsOf(id, ref.m3), m2: valAsOf(id, ref.m2), m1: valAsOf(id, ref.m1), prevDay: valAsOf(id, ref.prevDay), cur: c },

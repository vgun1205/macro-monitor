...
export async function sendIssuesMail(toOverride, opts = {}) {
  ...
  if (!opts.noAttach) {
    ...
    // MI 아카이브 검색 HTML 첨부(오프라인 과거 이슈 검색) — 오늘 저장분까지 포함
    try {
      ...
      attachments.push({ filename: `MI_아카이브_${genDate}.html`, content: buildArchiveHtml(arows, { generatedAt: genDate }), contentType: "text/html; charset=utf-8" });

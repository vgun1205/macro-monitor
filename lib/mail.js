...
function buildIssuesHtml(items, dateLabel, weekText, global = []) {
  ...
  const row = (n, color, title) => `<tr><td style="padding:4px 0;border-bottom:1px solid #eef1f4">
          <div style="font-size:14px;font-weight:600;color:#1a1d23;line-height:1.4"><span style="color:#${color};font-weight:700">(${n.source || "-"})</span> <a href="${n.link}" style="color:#1a1d23;text-decoration:none">${title}</a>${dt(n)}</div>
        </td></tr>`;

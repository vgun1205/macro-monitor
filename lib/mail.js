...
function buildIssuesHtml(items, dateLabel, weekText) {
  ...
  return `<div style="font-family:${FONT};color:#1a1d23">
    <h2 style="margin:0 0 2px;font-size:20px;font-weight:800">경제 이슈 및 규제 동향</h2>
    <div style="color:#6b7280;font-size:12.5px;margin:0 0 14px">${weekText} · ${dateLabel} · 키워드: 지급여력·K-ICS·보험 자본/규제</div>
    ${list}

...
function buildIssuesHtml(items, dateLabel, weekText, global = [], periodText = "", briefing = null) {
  ...
  const btnA = `<a href="${BASE}/archive/live" style="display:block;text-align:center;background:#1f3b57;color:#ffffff;text-decoration:none;font-size:13.5px;font-weight:700;padding:12px 8px;border-radius:10px;white-space:nowrap">📱 모바일용 아카이브 검색 ▶</a>`;

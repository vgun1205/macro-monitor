...
function buildIssuesHtml(items, dateLabel, weekText, global = [], periodText = "", briefing = null) {
  ...
  <div style="font-family:${FONT};background:#eef1f4;padding:12px 2%">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100%;max-width:820px;margin:0 auto;background:#fff;border-radius:10px;overflow:hidden;border:1px solid #e3e7ec">
      ...
      ${briefing && briefing.inner ? `<tr><td style="padding:8px 20px 0;text-align:center">
        <a href="${BASE}/briefing" style="display:inline-block;background:#0f766e;color:#ffffff;text-decoration:none;font-size:14px;font-weight:700;padding:11px 18px;border-radius:9px">🧭 주간 위험관리 AI 브리핑 · ${briefing.label || ""} <span style="font-size:9.5px;font-weight:400;color:#cdeee9">${briefing.range ? "(" + briefing.range + ")" : ""}</span> ▶</a>
      </td></tr>` : ""}
